...
nCycles = 100
scenario = "TWOPOOL_PHENO1.1_maxAvoid"
    ...
    #for(REP in 1:10){
      ...
      for(cycle in 1:nCycles){
        ...
        if(cycle == 1){
          ...
          EliteA <- randCross(EliteA, nCrosses = 50, nProgeny = 9)
          EliteB <- randCross(EliteB, nCrosses = 50, nProgeny = 9)
        ...
        if(cycle > 1){
          ...
          EliteA <- makeCross(EliteA, crossPlan = maxAvoidPlan(nInd = 100, nProgeny = 9))
          EliteB <- makeCross(EliteB, crossPlan = maxAvoidPlan(nInd = 100, nProgeny = 9))
