...
nCycles = 100
scenario = "PERSE_PHENO1.1_maxAvoidnCrosses50"
    ...
    #for(REP in 1:3){
      ...
      for(cycle in 1:nCycles){
        ...
        if(cycle == 1){
          ...
          Elite <- randCross(Elite, nCrosses = 50, nProgeny = 52)
        }
        ...
        if(cycle > 1){
          ...
          Elite <- makeCross(Elite, crossPlan = maxAvoidPlan(nInd = 100, nProgeny = 52))
