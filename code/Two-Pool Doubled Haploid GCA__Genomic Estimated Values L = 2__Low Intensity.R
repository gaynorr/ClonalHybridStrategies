...
nCycles = 100
scenario = "GCA_IH_GBLUP_maxAvoid"
    ...
    #for(REP in 1:10){
      ...
      for(cycle in 1:nCycles){
        ...
        if(cycle == 1){
          ...
          EliteA <- randCross(EliteA, nCrosses = 50, nProgeny = 3)
          EliteB <- randCross(EliteB, nCrosses = 50, nProgeny = 3)
        ...
        if(cycle > 1){
          ...
          EliteA <- makeCross(EliteA, crossPlan = maxAvoidPlan(nInd = 100, nProgeny = 3))
          EliteB <- makeCross(EliteB, crossPlan = maxAvoidPlan(nInd = 100, nProgeny = 3))
