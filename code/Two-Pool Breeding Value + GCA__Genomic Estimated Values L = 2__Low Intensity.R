...
nCycles = 100
scenario = "GEBVGCA_GBLUP_maxAvoid"
  ...
  #for(REP in 1:10){
    ...
    for(cycle in 1:nCycles){
      ...
      if(cycle == 1){
        ...
        EliteA <- selectWithinFam(EliteA, nInd = 4, use = "pheno")
        EliteB <- selectWithinFam(EliteB, nInd = 4, use = "pheno")
      }
      ...
      if(cycle > 1){
        ...
        EliteA <- selectWithinFam(EliteA, nInd = 4, use = "ebv")
        EliteB <- selectWithinFam(EliteB, nInd = 4, use = "ebv")
      }
