...
nCycles = 100
scenario = "PERSE_PHENO1.1_maxAvoidnCrosses20"
    ...
    #for(REP in 1:3){
      ...
      for(cycle in 1:nCycles){
        ...
        if(cycle == 1){
          ...
          Elite <- randCross(Elite, nCrosses = 20, nProgeny = 130)
        }
        ...
        if(cycle > 1){
          ...
          Elite <- makeCross(Elite, crossPlan = maxAvoidPlan(nInd = 40, nProgeny = 130))
